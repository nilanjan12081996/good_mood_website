      ...
      <div className="py-10 lg:py-20">
        <div className='max-w-6xl mx-auto px-5 lg:px-0'>
          ...
          <div className='mb-4'>
              ...
              <ul className='pl-5'>
                  <li className="text-[#424242] text-sm lg:text-[16px] leading-[24px] pb-2 list-disc"><strong>Email:</strong> refund@goodmood.solutions</li>
                  <li className="text-[#424242] text-sm lg:text-[16px] leading-[24px] pb-2 list-disc"><strong>Phone:</strong> +91-9062462268</li>
                  <li className="text-[#424242] text-sm lg:text-[16px] leading-[24px] pb-2 list-disc"><strong>Address:</strong> 136 Basunagar Gate No 1, Madhyamgram, Kolkata 700129</li>
              </ul>
          </div>
