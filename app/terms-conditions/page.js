        ...
        <div className='max-w-6xl mx-auto px-5 lg:px-0'>
            <div className="w-full lg:pb-8">
                ...
                <div className='mb-4'>
                    ...
                    <ul className='pl-5'>
                        <li className="text-[#424242] text-sm lg:text-[16px] leading-[24px] pb-2 list-disc">Email: contact@goodmood.solutions</li>
                        <li className="text-[#424242] text-sm lg:text-[16px] leading-[24px] pb-2 list-disc">Phone: +91-9062462268</li>
                        <li className="text-[#424242] text-sm lg:text-[16px] leading-[24px] pb-2 list-disc">136 Basunagar Gate No 1, Madhyamgram, Kolkata 700129</li>
                    </ul>
                </div>
                ...
                <div className='mb-4'>
                    <h3 className="text-[#031E2D] text-xl lg:text-[24px] leading-[32px] font-medium pb-2">21. Informational Use Only</h3>
                    <p className="text-[#424242] text-sm lg:text-[16px] leading-[24px] pb-2">
                        Mood Monk is an AI-based chatbot designed to provide general emotional well-being awareness, support and guidance. 
                        The responses generated are based on psychological knowledge and data, but Mood Monk is not a substitute for professional 
                        therapy, medical treatment, or counselling.
                    </p>
                </div>

                <div className='mb-4'>
                    <h3 className="text-[#031E2D] text-xl lg:text-[24px] leading-[32px] font-medium pb-2">22. No Professional or Legal Liability</h3>
                    <p className="text-[#424242] text-sm lg:text-[16px] leading-[24px] pb-2">
                        Mood Monk does not provide medical, clinical, or psychiatric advice. Any decisions or actions taken based on the chatbot’s 
                        responses are solely the responsibility of the user. No official, legal, or professional claims will be accepted or entertained 
                        against Mood Monk, its developers, or associated entities.
                    </p>
                </div>

                <div className='mb-4'>
                    <h3 className="text-[#031E2D] text-xl lg:text-[24px] leading-[32px] font-medium pb-2">23. Regulated Usage</h3>
                    <p className="text-[#424242] text-sm lg:text-[16px] leading-[24px] pb-2">
                        The usage of Mood Monk may be monitored, restricted, or moderated by the Good Mood Authority or the service 
                        administrators to ensure safe and appropriate use of the platform.
                    </p>
                </div>

                <div className='mb-4'>
                    <h3 className="text-[#031E2D] text-xl lg:text-[24px] leading-[32px] font-medium pb-2">24. Emergency Situations</h3>
                    <p className="text-[#424242] text-sm lg:text-[16px] leading-[24px] pb-2">
                        If you are experiencing a mental health emergency, crisis, or thoughts of self-harm, you must contact a 
                        qualified mental health professional or your local emergency services immediately.
                    </p>
                </div>

                <div className='mb-4'>
                    <h3 className="text-[#031E2D] text-xl lg:text-[24px] leading-[32px] font-medium pb-2">25. Acceptance of Terms</h3>
                    <p className="text-[#424242] text-sm lg:text-[16px] leading-[24px] pb-2">
                        By accessing or using the Mood Monk chatbot in our app or website, you confirm that you have read, understood, and agreed to these Terms & Conditions.
                    </p>
                </div>
