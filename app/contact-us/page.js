                        ...
                        <div className="lg:w-5/12 bg-[#FFCE73] rounded-[10px] shadow-xl p-5 lg:p-10 mb-6 lg:mb-0">
                            ...
                            <div className='mb-4 pb-5 flex items-center'>
                                ...
                                <div className='w-9/12'>
                                    ...
                                    <div className='text-[12px] lg:text-[12px] leading-[16px] font-medium text-[#022A14] pl-0'>136 Basunagar Gate No 1, Madhyamgram, Kolkata 700129</div>
                                </div>
                            </div>
                            <div className='mb-4 pb-5 flex items-center'>
                                <div className='w-3/12'>
                            ...
                            <div className='mb-4 pb-5 flex items-center'>
                                ...
                                <div className='w-9/12'>
                                    ...
                                    <div className='text-[12px] lg:text-[12px] leading-[16px] font-medium text-[#022A14] pl-0'>contact@goodmood.solutions</div>
                                </div>
                            </div>
                        </div>
